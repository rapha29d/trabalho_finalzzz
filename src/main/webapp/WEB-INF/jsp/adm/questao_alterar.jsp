            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12 text-left">
                    <ol class="breadcrumb">
                     ...
                     <div class="panel-heading bg-dark" style="color:white">&nbsp<i class="fa fa-pencil"></i> Editar Questão</div>
                     <br>
                    <form class="form-horizontal" action="/aplicacao/adm/questao_atualizar" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-control" id="sel1" name="questao.codigo_categoria">
                                    <c:forEach var="categoria" items="${usuario.categorias}" varStatus="i">
                                        <option value="${categoria.codigo}" <c:if test="${questao.codigo_categoria==categoria.codigo}">selected</c:if>>${categoria.nome}</option>
                        ...
                        <input type="hidden" value="${questao.codigo}" name="questao.codigo">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="pergunta" >Pergunta:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="pergunta" placeholder="Entre com a pergunta" name="questao.pergunta" required="" value="${questao.pergunta}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="desc" >Descriçao:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="desc" placeholder="digite descriçao" name="questao.descricao" value="${questao.descricao}">
                            </div>
                        </div>
                        <br>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <c:forEach var="alternativa" items="${questao.alternativas}" varStatus="i">
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="a${i.count}" >${alternativa.alphabet[i.index]})</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="a${i.count}" placeholder="Alternativa ${alternativa.alphabet[i.index]}" name="alternativas[${i.index}].alternativa" required="" value="${alternativa.alternativa}">
                                            <input type="hidden" name="alternativas[${i.index}].codigo" value="${alternativa.codigo}">
                                        </div>
                                    </div>
                                </c:forEach>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" id="sel12" name="resp">
                                            ...
                                            <c:forEach var="alternativa" items="${questao.alternativas}" varStatus="i">
                                                <option value="${i.index}" <c:if test="${alternativa.valor==1}">selected</c:if>>${alternativa.alphabet[i.index]}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                ...
                                <br>
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-info"  name="editar"><i class="fa fa-edit"></i> Atualizar</button>
                                    <a href="#"> <button type="button" class="btn btn-danger" style="float:right" onclick="goBack()"><i class="fa fa-close"></i> Cancelar</button></a>
                                </div>
