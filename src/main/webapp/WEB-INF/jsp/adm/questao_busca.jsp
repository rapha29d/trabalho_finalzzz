<%-- 
    Document   : questao_busca
    Created on : 15/11/2017, 17:28:54
    Author     : raphael
--%>
...
<html>
    <head>
        ...
        <title>Aplicacao - buscar questoes</title>
        <!-- Bootstrap core CSS-->
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12 text-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Gerenciar / Buscar</li>
                    </ol>
                    ...
                    <div class="card mb-3">
                        <div class="card-header bg-dark" style="color:white" >
                            <i class="fa fa-search"></i> Resultado da Busca</div>
                        <div class="card-body">
                            <c:set var="total" value="${0}" />
                            <c:forEach var="questao" items="${questoes}" varStatus="i">
                                <div class="card">
                                    <br>
                            ...
                            <c:if test="${total==0}">
                                <h4 style="color:#555558;">Nenhum resultado encontrado para ${busca}.</h4>
                            </c:if>
                        </div>
