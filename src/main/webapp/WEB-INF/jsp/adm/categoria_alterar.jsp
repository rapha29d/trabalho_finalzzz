...
<html>
    <head>
        ...
        <title>Aplicacao -Alterar categoria</title>
        <!-- Bootstrap core CSS-->
                ...
                <div class="col-sm-12 text-left">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="/aplicacao/adm/categoria_nova">Categoria</a>
                        </li>
                        <li class="breadcrumb-item active">Editar</li>
                    </ol>
                    <form class="form-horizontal" action="/aplicacao/adm/categoria_atualizar" method="post">
                        <input type="hidden" value="2" name="opc" />
                        <div class="panel panel-default">
                            <div class="panel-heading bg-dark" style="color:white">&nbsp<i class="fa fa-pencil"></i> Editar Categoria</div>
                            <div class="panel-body">
                               <input type="hidden" name="categoria.codigo" value="${categoria.codigo}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Nome" placeholder="Nome da categoria" name="categoria.nome" value="${categoria.nome}">
                                    </div>
                                </div>
                                ...
                                <br>
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-info" name="atualizar"><i class="fa fa-edit"></i> Atualizar</button>
                                    <a href="/aplicacao/adm/categoria_nova"> <button type="button" class="btn btn-danger " style="float:right"><i class="fa fa-close"></i> Cancelar</button></a>
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body" id="confirmMessage">
                            <p><i class="fa fa-fw fa-warning"></i>Deseja realmente remover essa categoria?</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" id="confirmOk" data-dismiss="modal">Ok</button>
