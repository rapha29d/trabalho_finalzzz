<%-- 
    Document   : questao_gerenciar_categoria
    Created on : 14/11/2017, 17:17:45
    Author     : raphael
--%>
...
<html>
    <head>
        ...
        <title>Aplicacao - Gerenciar questoes de ${categoria.nome}</title>
        <!-- Bootstrap core CSS-->
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12 text-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Gerenciar / ${categoria.nome}</li>
                    </ol>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <c:forEach var="questao" items="${categoria.questoes}" varStatus="i">
                              ...
                              <c:if test="${total==0}">
                                <h4 style="color:#555558;">Nenhuma questão em ${categoria.nome}.</h4>
                            </c:if>    
                        </div>
